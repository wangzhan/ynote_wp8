...
namespace YNote
{
    public partial class App : Application
    {
        ...
        /// OAuthController
        public static OAuthController oauthController = new OAuthController();

        /// app setting
        public static AppSettings appSettings = new AppSettings();

        /// remote server access
        public static RepositoryAccess repositoryAccess = new RepositoryAccess();

        /// database access, need to initialize or clear
        public static DatabaseAccess databaseAccess = new DatabaseAccess();

        /// sync controller object
        public static SyncController syncController = new SyncController();

        /// oauth folder
        public static AppFolderController appFolderController = new AppFolderController();
        ...
        {
            // load data
            appSettings = AppSettings.LoadData(string.Empty);
            if (appSettings.HasAuthorization())
            {
                await appFolderController.InitializeFoldersAsync(appSettings.UserName);
                databaseAccess.Initialize(appFolderController.DatabasePath);

                oauthController.AccessToken = appSettings.AccessToken;
                oauthController.AccessSecret = appSettings.AccessTokenSecret;
            }
        }
